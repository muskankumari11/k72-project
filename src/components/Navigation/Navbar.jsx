...
const Navbar = () => {
    ...
    const isDarkLogoPage = location.pathname.toLowerCase().includes('agence') || location.pathname.toLowerCase().includes('projects')
    const logoColor = isDarkLogoPage ? 'black' : 'white'
